                        ...
                        <div className="glass dark:glass-dark p-8 rounded-2xl">
                            ...
                            <div className="mt-12">
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <a href="https://www.linkedin.com/in/rizwanshafique1/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full glass dark:glass-dark flex items-center justify-center hover:bg-primary-light hover:text-white transition-all">
